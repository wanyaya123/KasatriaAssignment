...
// Glass-style tile: tinted see-through fill + brighter glowing border
export function getNetWorthStyle(netWorth) {
	if (netWorth < 100000) {
		return {
			background: 'rgba(220, 53, 69, 0.58)',
			border: 'rgba(255, 110, 120, 0.95)',
			glow: 'rgba(220, 53, 69, 0.7)',
		};
	}
	...
	if (netWorth <= 200000) {
		return {
			...
			border: 'rgba(255, 220, 80, 0.95)',
			glow: 'rgba(255, 193, 7, 0.7)',
		};
	}

	return {
			background: 'rgba(40, 167, 69, 0.58)',
		border: 'rgba(90, 230, 130, 0.95)',
		glow: 'rgba(40, 167, 69, 0.7)',
	};
}
...
// Fetches data from Google Sheets and parses it
